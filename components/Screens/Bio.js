...
import { StyleSheet,View,Text,SafeAreaView,TouchableOpacity,TextInput, FlatList, ScrollView, ImageBackground, TextInputBase } from 'react-native'
       ...
       <SafeAreaView>
            <View style={styles.WrapperHeader}>
                <View style={styles.HeaderLeft}>
                    ...
                    <Text style={styles.HeaderLeftText}>Edit Bio</Text>
                </View>
                <TouchableOpacity>
        ...
        <View style={styles.WrapperNameArea}>
           <Text style={styles.NameAreaText}>Bio</Text>
           <TextInput
            multiline
            numberOfLines={10}
